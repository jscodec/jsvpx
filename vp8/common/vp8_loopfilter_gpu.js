...
function vp8_loop_filter_row_simple_gpu(ctx, row) {
    var y = 0;
    var y_off = 0;
    var stride = 0;
    var mbi;
...
function vp8_loop_filter_row_normal_gpu(ctx, row, start_col, num_cols) {
...
module.exports = {};
module.exports.vp8_loop_filter_row_normal_gpu = vp8_loop_filter_row_normal_gpu;
module.exports.vp8_loop_filter_row_simple_gpu = vp8_loop_filter_row_simple_gpu;